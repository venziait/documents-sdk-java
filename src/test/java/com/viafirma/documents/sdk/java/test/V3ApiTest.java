...
public class V3ApiTest {
    ...
    private static final String USER_CODE = "fgomez";
    private static final String USER_PASSWORD = "qwerty";
    private static final String DEVICE_CODE = "fgomez";

    private static final OAuthType OAUTH_TYPE = OAuthType.OAUTH_USER;
    private static final String API_URL = "http://192.168.10.94:8080/documents/api";
    private static final String CONSUMER_KEY = "com.viafirma.documents";
    private static final String CONSUMER_SECRET = "7380861927";
    private static final String AUTH_MODE = "client_auth";

    private static final String MESSAGE_SIGNED_CODE = "XXXXXXXXXXXXX";

    private static final String OCR_TEMPLATE_KEY = "es.DNI.FRONT";
    ...
    public String sendMenssageWithOCR() throws ApiException{
        //BEGIN-SNIPPET: api_v3_send_message_with_ocr_evidence
        Message message = new Message();
    ...
    @Test
    public void t11GetMessageWithOCREvidenceByCode() {
        try {
            String messageCode = sendMenssageWithOCR();
            //BEGIN-SNIPPET: api_v3_get_message_with_ocr_evidence
            Message message = V3messagesApi.getInstance().getMessageByCode(messageCode);
            //END-SNIPPET
            Assert.assertNotNull(message);
        } catch (ApiException e) {
